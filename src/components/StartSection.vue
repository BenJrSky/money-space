        ...
        <div class="wrapper">
          <div class="left">
            <div class="bannerInfo">
              <span class="slogan font-prompt" style="font-size: 38px">{{ t("slogan1") }}</span>
              <p style="font-size: 18px">{{ t("slogan2") }}</p>
              ...
              <div class="animationWrapper animated">
                ...
                <div class="createLinkPayForm animated">
                  <div class="paymentForm">
                    <div class="headBlock">
                      <div class="formTitle" style="font-size: 18px">{{ t("startSection.createLinkPayForm.checkout") }}</div>
                      <div class="siteLogo2">
